...
import babel7_8compat from "../../test/babel-7-8-compat/data.json" with { type: "json" };

import bit from "../../scripts/babel-plugin-bit-decorator/plugin.cjs";
import nodeProtocol from "../../scripts/babel-plugin-transform-node-protocol-import/plugin.cjs";
